...
CINEMATIC_SCENES = {
    ...
    "city_traffic_night": [
        "empty city street night rain puddle reflection cinematic",
        "highway night long exposure car lights moody",
        "rainy city intersection night neon reflection",
        "urban street night rain wet road cinematic",
        "night city road empty rain moody dark",
    ],
    "city_skyline_night": [
